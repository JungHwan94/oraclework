...
SELECT EMP_NAME, SALARY*12 연봉, SALARY*12 + NVL(SALARY*BONUS, 0) "총수령액(보너스포함)", (SALARY*12 + NVL(SALARY*BONUS, 0)) - (SALARY*12 * 0.03) 실수령액
FROM EMPLOYEE;
...
SELECT EMP_NAME, SALARY, (SALARY*12 + NVL(SALARY*BONUS, 0)) - (SALARY*12 * 0.03), HIRE_DATE
FROM EMPLOYEE
